...
class CreateGigFactory(val firestore: FirebaseFirestore,val firebaseStorage: FirebaseStorage) : ViewModelProvider.Factory {
    override fun <T : ViewModel> create(modelClass: Class<T>): T {
        return CreateGigViewModel(firestore,firebaseStorage) as T
    }
}