...
class RatingFactory(val firestore: FirebaseFirestore, val firebaseStorage: FirebaseStorage) : ViewModelProvider.Factory {
    override fun <T : ViewModel> create(modelClass: Class<T>): T {
        return RatingViewModel(firestore,firebaseStorage) as T
    }
}